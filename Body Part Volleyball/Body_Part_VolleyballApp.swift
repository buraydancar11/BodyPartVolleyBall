...
class AppDelegate: NSObject, UIApplicationDelegate {
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey : Any]? = nil) -> Bool {
        ...
        // Configure AppsFlyer
        AppsFlyerLib.shared().appsFlyerDevKey = "mrTzWhrTQJeEmy9RnthtGS"
        AppsFlyerLib.shared().appleAppID = "6755414271"
        AppsFlyerLib.shared().isDebug = false // Production ke liye false rakhein
...
@main
struct Body_Part_VolleyballApp: App {
...
class ServerResponseHandler: ObservableObject {
    ...
    private var serverURL: String {
        if let url = Bundle.main.object(forInfoDictionaryKey: "ServerBaseURL") as? String {
            return url + "/ios-bodypart-volleyball/server.php"
        }
        return "https://gtappinfo.site/ios-bodypart-volleyball/server.php"
    }
    ...
    var body: some View {
        ZStack {
            ...
            Rectangle()
                ...
                .overlay(
                    VStack {
                        ...
                        VStack(spacing: 20) {
                            ...
                            Text("Your game instructions will go here...")
                                .font(.body)
                                .foregroundColor(.white)
                ...
                .cornerRadius(20)
                .padding(.horizontal, 30) // Horizontal spacing
                .padding(.vertical, 100)  // Vertical spacing
        }
    }
}
